...
<?php if($data['inf'] == ""){ ?>
                    ...
                    <img src="<?php echo($host.'/images/no_image.png'); ?>" alt="" class="img-circle profile_img">
<?php }else{ ?>

                    <img src="<?php echo($host.'/'.$data['inf']['img']); ?>" alt="" class="img-circle profile_img">
<?php } ?>
               <!--  <img src="<?php echo $host.$data['inf']['imglogo']?>" alt="..." class="img-circle profile_img"> -->
              </div>
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-desktop"></i> Reports <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="/searchconsole/index?id=<?=$_GET['id'] ?>">Search console</a></li>
                      <li><a href="/serplab/index?id=<?=$_GET['id'] ?>">Serplab</a></li>
                      <li><a href="/gmetrixnew/index?id=<?=$_GET['id'] ?>">Gmetrix</a></li>
                      <!-- <li><a href="/client/onlymode?id=<?=$_GET['id'] ?>">View-only mode</a></li> -->
...
<?php if($data['info'] == ""){ ?>
                    <img src="<?php echo $host.'/images/no_image.png'?>" alt=""><?php echo $data['info']['name'];?>
<?php }else{ ?>
                    <img src="<?php echo $host.'/'.$data['inf']['img']?>" alt=""><?php echo $data['info']['name'];?>
<? } ?>
                ...
                <li>
                    <a href="#" class="edit-client" data-toggle="modal" class="edit-button" data-target="#client1" >
