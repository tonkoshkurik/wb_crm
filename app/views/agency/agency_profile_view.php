  ...
  echo $error;
          ...
          <div class="col-md-3">
              <div class="home-active">
                    <img src="<?php echo $host.'/'.$data['inf']['imglogo']?>" class="logoclient" alt="Mountain View" >
          ...
          <div class="col-md-4">
           <table class="table table-hover tableagen">
             <tr>
           ...
           <button type="submit" name="id" value="<?php echo $data['inf']['id']?>" data-toggle="modal" data-target="#editprof" class="btn btn-primary butagen">Edit</button>
       </div>
